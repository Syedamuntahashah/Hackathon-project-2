...
const ProductDetail = () => {
  ...
  return (
    <div>
      <Header cartCount={cartCount} showCartNotification={showCartNotification} />
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1">
            ...
            <p className={`mb-4 ${product.stockLevel > 0 ? "text-green-500" : "text-red-500"}`}>
            ...
            <div className="flex items-center gap-4">
              <button 
                className="flex items-center justify-center border border-black px-10 rounded-2xl w-auto h-[64px] shadow-lg hover:scale-110 transition-transform duration-300 ease-in-out"
